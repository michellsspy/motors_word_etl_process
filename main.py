...
def main(argv=None):
    ...
    options = PipelineOptions(
        ...
        #docker_registry_push_url='southamerica-east1-docker.pkg.dev/motors-word-etl-process/bach-motors-word-etl-process/motors-word-etl-process-dev:latest',
        sdk_container_image='southamerica-east1-docker.pkg.dev/motors-word-etl-process/bach-motors-word-etl-process/motors-word-etl-process-dev:latest',
    ...
    from functions.get_names import GetNames
